...
//  Precondition(s):
//    <1> a_image != NULL
//    <2> ObjStringParsing::isValidFilenameWithPath(a_image)
...
//    <7> The height of a_image is equal to or half of the width
//        of a_image
...
//              characters in the font
//  Precondition(s):
//    <1> ObjStringParsing::isValidFilenameWithPath(image)
