...
namespace
{
	...
	//
	//  This varaible has to by dynamically alloated so that it
	//    is not destroyed when the program crashes.
	//    -> If it is destroyed, the destructor trys to free the
	//       graphics memory, and that can cause a crash if the
	//       OpenGL context was destroyed first
